...
const Linea2Checklist = ({ formData, handleChange, handleArrayChange }) => {
  ...
  return (
    <>
          ...
          <Form.Group className="mb-3">
            ...
            <div className="d-flex">
              <Button
                ...
                onKeyPress={(e) => handleKeyPress(e, enjuagueRefs[7])}
              >
                {formData.enjuagues[6]?.nivel
                  ? "✅ Piezas tapadas"
                  : "Que tape las piezas"}
      ...
      {/* Enjuague 8 */}
      <Card className="mb-4">
        <Card.Header as="h5">Enjuague 8</Card.Header>
        <Card.Body>
          <Form.Group className="mb-3">
            <Form.Label>Nivel</Form.Label>
            <div className="d-flex">
              <Button
                ref={enjuagueRefs[7]}
                variant="outline-primary"
                style={toggleStyle(formData.enjuagues[7]?.nivel || false)}
                onClick={() =>
                  handleArrayChange(
                    "enjuagues",
                    7,
                    "nivel",
                    !formData.enjuagues[7]?.nivel
                  )
                }
                onKeyPress={(e) => handleKeyPress(e, enjuagueRefs[8])}
              >
                {formData.enjuagues[7]?.nivel
                  ? "✅ Piezas tapadas"
                  : "Que tape las piezas"}
      ...
      {/* Enjuague 9 */}
      <Card className="mb-4">
        <Card.Header as="h5">Enjuague 9</Card.Header>
        <Card.Body>
          <Form.Group className="mb-3">
            <Form.Label>Nivel</Form.Label>
            <div className="d-flex">
              <Button
                ref={enjuagueRefs[8]}
                variant="outline-primary"
                style={toggleStyle(formData.enjuagues[8]?.nivel || false)}
                onClick={() =>
                  handleArrayChange(
                    "enjuagues",
                    8,
                    "nivel",
                    !formData.enjuagues[8]?.nivel
                  )
                }
...
export default Linea2Checklist;